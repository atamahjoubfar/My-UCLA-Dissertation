\begin{center}
{\Large \bf Relation Between Delay Line Phase Noise and Ring Oscillator Phase Noise}                        
                \vskip.2in
...
{\large \bf Abstract}
\end{center}
{\bf The phase noise of a ring oscillator can be obtained by multiplying its open-loop phase noise by a simple shaping function. The shaping
...
Keywords: phase noise, jitter, flicker noise, white noise, oscillator phase noise, inverter phase noise.}
...
The phase noise in ring oscillators has been studied extensively \cite{Mcneill}-\cite{Grozing}.
...
The output of the third inverter in Fig. \ref{chain}(a) can be decomposed into an ideal square wave and a train of narrow pulses \cite{Perrott,Galton} that occur every $3 T_d=T_{in}/2$
...
The output waveform obtained in the above experiment can be decomposed as shown in Fig. \ref{ring}(c) and expressed as a single pulse of width $\Delta T_1$, convolved with an
...
and hence
\beq
G(f)=\left[\frac{1}{T_{in}} ~ (1 - e^{-j \pi f T_{in}}) \SumAll n \delta (f-n f_{in})\right] * \left[ \frac{1}{j2\pi f}+\frac{1}{2}\delta
(f) \right],
\label{gf1}
\eeq
which simplifies to 
...
%TSMC's University Shuttle Program for chip fabrication. This work was supported by
...
\special{psfile=Figures/3inverters hoffset=-50 voffset=80 vscale=120 hscale=120}
\label{chain}
\end{figure*}
...
\special{psfile=Figures/3stage_ring hoffset=-50 voffset=90 vscale=120 hscale=120}
\label{ring}
\end{figure*}
...
\special{psfile=Figures/chain2ring hoffset=-50 voffset=15 vscale=120 hscale=120}
\label{chain2ring}
\end{figure}
...
\special{psfile=Figures/lowfreqamp hoffset=-50 voffset=35 vscale=120 hscale=120}
\label{lowfreqamp}
\end{figure}

\begin{figure}[htb]
\vspace{3in}
\special{psfile=Figures/P2NR2F.eps hoffset=60 voffset=-120 vscale=60 hscale=60}
\vspace{3in}
\special{psfile=Figures/spurzoom.eps hoffset=60 voffset=-120 vscale=60 hscale=60}
\vspace{0.25in}
\special{psfile=Figures/ab hoffset=60 voffset=15 vscale=90 hscale=90}
\vspace{2.3in}
\special{psfile=Figures/ISF hoffset=0 voffset=0 vscale=120 hscale=120}
...
\begin{figure}[htb]
\vspace{3in}
\special{psfile=Figures/sim9stage.eps hoffset=60 voffset=-120 vscale=60 hscale=60}
\vspace{3in}
\special{psfile=Figures/sim19stage.eps hoffset=60 voffset=-120 vscale=60 hscale=60}
\vspace{0.25in}
\special{psfile=Figures/ab hoffset=60 voffset=15 vscale=90 hscale=90}
...
\begin{figure}[htb]
\vspace{3in}
\special{psfile=Figures/numberofstages2.eps hoffset=60 voffset=-120 vscale=60 hscale=60}
...
\begin{figure}[htb]
\vspace{3in}
\special{psfile=Figures/compacteq.eps hoffset=60 voffset=-120 vscale=60 hscale=60}
...
\begin{figure}[htb]
\vspace{1.6in}
\special{psfile=Figures/die.eps hoffset=60 voffset=10 vscale=100 hscale=100}
...
\begin{figure}[htb]
\vspace{3in}
\special{psfile=Figures/DL.eps hoffset=60 voffset=-120 vscale=60 hscale=60}
...
\special{psfile=Figures/setup hoffset=-50 voffset=15 vscale=120 hscale=120}
\label{setup}
\end{figure}

\begin{figure}[htb]
\vspace{3in}
\special{psfile=Figures/meas9stage.eps hoffset=60 voffset=-120 vscale=60 hscale=60}
\vspace{3in}
\special{psfile=Figures/meas19stage.eps hoffset=60 voffset=-120 vscale=60 hscale=60}
\vspace{0.25in}
\special{psfile=Figures/ab hoffset=60 voffset=15 vscale=90 hscale=90}
...
%respectively. He is currently working towards the Ph.D. degree at the University
%of California, Los Angeles. His research interests include RF/Analog/Mixed-mode
